...
See the [SLOG over-provisioning guide](https://www.truenas.com/docs/scale/storage/disks/slogoverprovision/) for more information.
...
{{< trueimage src="/images/CORE/Storage/StoragePoolsDatasetCreateSlogRecommends.png" alt="Enabling a SLOG for Asynchronous Writes" id="Enabling a SLOG for Asynchronous Writes" >}}
