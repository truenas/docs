...
* [**ZFS Datasets**](https://www.truenas.com/docs/scale/datasets/): similar to a conventional mounted filesystem.
...
* [**ZFS zvols**](https://www.truenas.com/docs/scale/datasets/): datasets that represent block devices.
...
* [**Fusion Pool**](https://www.truenas.com/docs/scale/storage/pools/) (or metadata vdev): is a special class of vdev.
...
* [**ZFS Snapshots**](https://www.truenas.com/docs/scale/datasets/): read-only copy of a file system or volume.
...
* [**ZFS Scrub**](https://www.truenas.com/docs/scale/storage/pools/managepools/): the process that ZFS uses to verify the data on disk.
  All of the data is read and checked against the computed checksums to verify that no corruption has occurred.

* [**ZFS Resilver**](https://www.truenas.com/docs/scale/storage/pools/managepools/): process to reconstruct data on a disk when that disk has replaced a failed disk.

* [**ZFS Replication**](https://www.truenas.com/docs/scale/dataprotection/replication/): copying a ZFS dataset to another dataset.
...
* [**Cloud Sync**](https://www.truenas.com/docs/scale/dataprotection/cloudsynctasks/): TrueNAS sending, receiving, or synchronizing data with a Cloud Storage provider like Amazon S3, Google Cloud, or Microsoft Azure.
