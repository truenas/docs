...
{{< include file="/static/includes/time-machine-multiprotocol.md" >}}
...
{{< trueimage src="/images/system-settings/services-nfs-add-kerberos-spn-entry.png" alt="Add Kerberos SPN Entry" id="Add Kerberos SPN Entry" >}}
...
{{< trueimage src="/images/shares/nfs-widget-options.png" alt="Unix (NFS) Shares Widget Options" id="Unix (NFS) Shares Widget Options" >}}
...
We recommend using [Active Directory](# <!-- TODO-REF: configadscale -->) to enable Kerberos security for the NFS share.
...
{{< trueimage src="/images/datasets/add-multimode-dataset.png" alt="Adding a Multi-Mode Dataset and Share" id="Adding a Multi-Mode Dataset and Share" >}}
...
See [Creating Datasets](# <!-- TODO-REF: DatasetsSCALE.md#creating-a-dataset -->) for more information on adding and customizing datasets.
...
2. Select **Multi-Protocol Shares** on the **Purpose** dropdown list.
   ...
   {{< trueimage src="/images/shares/edit-smb-multi-protocol-share.png" alt="Edit SMB Purpose" id="Edit SMB Purpose" >}}

   Click **Advanced Options** to modify any settings you want to use. Multi-protocol shares cannot use APPL extension settings like Time Machine.
...
1. Select the new share listed on **Unix (NFS) Shares** widget, click on the <span class="material-icons">more_vert</span> icon and then click **Edit**.
   The **Edit NFS** screen opens with the **Basic Options** settings showing.
    ...
    {{< trueimage src="/images/shares/edit-nfs-multi-protocol-share.png" alt="Edit NFS Multi-Protocol Share" id="Edit NFS Multi-Protocol Share" >}}
...
2. Enable Kerberos security. Click **Advanced Options**.
   ...
   {{< trueimage src="/images/shares/edit-nfs-share-advanced-security-setting.png" alt="Advanced Options Security Settings" id="Advanced Options Security Settings" >}}
...
{{< trueimage src="/images/shares/edit-multimode-share-dataset-permissions.png" alt="Editing Share Dataset ACL" id="Editing Share Dataset ACL" >}}
...
{{< trueimage src="/images/datasets/edit-multimode-dataset-permissions.png" alt="Editing Multi-Mode Dataset Permissions" id="Editing Multi-Mode Dataset Permissions" >}}
...
See [Permissions](# <!-- TODO-REF: PermissionsScale -->) for more information on editing dataset permissions.
...
For more information on accessing shares, see [Mounting the SMB Share](# <!-- TODO-REF: /SCALE/SCALETutorials/Shares/SMB#mounting-the-smb-share -->) and [Connecting to the NFS Share](# <!-- TODO-REF: adding-nfs-shares.md#connecting-to-the-nfs-share -->).