...
1. [Create the user(s)](# <!-- TODO-REF: ManageUsers -->) for this SMB share.
...
Alternatively, configure snapshot lifetimes or create an automatic deletion policy via the [Periodic Snapshot Tasks screen](# <!-- TODO-REF: PeriodicSnapshotTasksSCALE -->). This screen helps users manage the snapshot count more effectively.
...
You can either [create the dataset](# <!-- TODO-REF: DatasetsSCALE -->) to use for the share on the **Add Dataset** screen and the share, or create the dataset when you add the share on the **Add SMB** screen.
...
{{< trueimage src="/images/shares/add-smb-time-machine-basic.png" alt="Add Basic Time Machine Share" id="Add Basic Time Machine Share" >}}
