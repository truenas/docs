...
* [Create user accounts](# <!-- TODO-REF: ManageUsers -->) for media users who access the share.
...
4. Select **Enable Apple SMB2/3 Protocol Extensions**.
   ...
   {{< trueimage src="/images/system-settings/smb-service-apple-extensions.png" alt="Enable Apple SMB2/3 Extensions" id="Enable Apple SMB2/3 Extensions" >}}
...
4. Enter a name for the dataset (e.g., *AppleMediaShare* or *FCPProjects*) and click **Create**.
   ...
   {{< trueimage src="/images/shares/add-smb-macos-media-basic.png" alt="Add Final Cut Pro Storage Share - Basic Options" id="Add Final Cut Pro Storage Share - Basic Options" >}}
...
8. If Apple SMB2/3 Protocol Extensions are not enabled, a requirement error appears below the **Purpose** field.
   ...
   {{< trueimage src="/images/shares/macos-enable-ext.png" alt="Final Cut Pro Storage Share Extension Required" id="Final Cut Pro Storage Share Extension Required" >}}
...
2. Configure **Access** settings as needed:
   ...
   * **Access Based Share Enumeration**: Select to enable if needed for your access control requirements.
   ...
   {{< trueimage src="/images/shares/add-smb-macos-media-advanced-options.png" alt="Final Cut Pro Storage Share - Advanced Options" id="Final Cut Pro Storage Share - Advanced Options" >}}
...
See [Managing SMB Shares](# <!-- TODO-REF: manage-smb-shares.md -->) for detailed information on configuring ACL permissions.
