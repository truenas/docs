...
2. [Create the SMB share and dataset](#adding-an-smb-share-and-dataset).
   ...
   When setting up multi-protocol (SMB and NFS) shares, refer to the [Multiprotocol Shares](# <!-- TODO-RELREF: MixedModeShares.md -->) tutorial for configuration instructions.
...
See [Managing SMB Shares](# <!-- TODO-REF: manage-smb-shares -->) for more information on these options.

See [Permissions](# <!-- TODO-REF: PermissionsScale -->) for more information on dataset permissions.
