...
{{< include file="/static/includes/adding-a-user.md" >}}
...
See [Managing Users](# <!-- TODO-REF: ManageUsers -->) for more information on adding home directories.
...
We recommend using the [**Add Dataset** screen](# <!-- TODO-REF: DatasetsSCALE -->) to access the dataset advanced setting options when you want to customize the dataset, and using the **Add SMB** screen to create and customize an SMB share with presets and advanced options.
...
1. Select **Private Dataset Share** on the **Purpose** dropdown list, then click **Advanced Options** to configure additional share setting options.
   ...
   {{< trueimage src="/images/shares/add-private-smb-share-advanced-options.png" alt="Add Share Advanced Options" id="Add Share Advanced Options" >}}
...
3. Enter the private dataset name, for example *rikka-private*, then click **Create Dataset**.
   ...
   {{< trueimage src="/images/shares/edit-private-share-dataset.png" alt="Edit Private Share Dataset" id="Edit Private Share Dataset" >}}
...
- From the **Datasets** screen, select the dataset row for the private share dataset.
  ...
  See [Setting Up Permissions](# <!-- TODO-REF: PermissionsSCALE -->) for more information on editing dataset permissions.
...
{{< trueimage src="/images/shares/set-acl-preset-for-private-dataset.png" alt="Add Dataset ACL Permissions" id="Add Dataset ACL Permissions" >}}

{{< trueimage src="/images/datasets/group-domain-admins.png" alt="Set the owning group to Domain Admins" id="Set the owning group to Domain Admins" >}}
...
{{< trueimage src="/images/shares/share-acl-for-private-dataset-share.png" alt="Set the Share ACL Permissions" id="Set the Share ACL Permissions" >}}
...
Go to **Storage** and [create a pool](# <!-- TODO-REF: CreatePoolWizard -->).

Next, [set up the Active Directory](# <!-- TODO-REF: /SCALE/SCALETutorials/credentials/directoryservices/configadscale -->) that you want to share resources with over your network.
