...
{{< trueimage src="/images/shares/windows-smb-share-widget-no-shares.png" alt="Windows (SMB) Share Widget without Shares" id="Windows (SMB) Share Widget without Shares" >}}
...
{{< trueimage src="/images/shares/windows-smb-share-widget.png" alt="Windows (SMB) Share Widget with Shares" id="Windows (SMB) Share Widget with Shares" >}}
...
{{< trueimage src="/images/shares/delete-smb-share-dialog.png" alt="Delete SMB Share" id="Delete SMB Shares" >}}
...
{{< trueimage src="/images/shares/shares-smb-screen.png" alt="Shares SMB Screen" id="Shares SMB Screen" >}}
...
{{< trueimage src="/images/shares/add-smb-advanced-audit-logging-settings.png" alt="SMB Audit Logging" id="SMB Audit Logging" >}}
...
{{< trueimage src="/images/shares/add-smb-advanced-other-settings-default-share.png" alt="Other Options Settings" id="Other Options Settings" >}}
...
{{< trueimage src="/images/shares/add-smb-advanced-settings-time-machine-share.png" alt="Other Options - Time Machine Share" id="Other Options - Time Machine Share" >}}
...
{{< trueimage src="/images/shares/add-smb-advanced-settings-time-locked-share.png" alt="Other Options - Time Locked Shares" id="Other Options - Time Locked Shares" >}}
...
{{< trueimage src="/images/shares/add-smb-advanced-settings-private-datasetsl-share.png" alt="Other Options - Private Dataset Share" id="Other Options - Private Dataset Share" >}}
...
{{< trueimage src="/images/shares/smb-settings-final-cut-pro.png" alt="Other Options - Final Cut Pro Storage Share" id="Other Options - Final Cut Pro Storage Share" >}}

{{< include file="/static/includes/macos-media-share-compatibility.md" >}}
...
{{< include file="/static/includes/smb-vfs-configuration-warning.md" >}}
...
{{< trueimage src="/images/shares/create-dataset-dialog.png" alt="Create Dataset Dialog" id="Create Dataset Dialog" >}}
...
{{< trueimage src="/images/shares/smb-share-acl-screen.png" alt="SMB Share ACL Screen" id="SMB Share ACL Screen" >}}
...
See **Edit ACL Screen** for more information on the settings found on this screen.

{{< trueimage src="/images/shares/smb-acl-editor.png" alt="SMB ACL Editor" id="SMB ACL Editor" >}}
...
{{< trueimage src="/images/shares/smb-status-screen-sessions-tab.png" alt="SMB Status Sessions Tab" id="SMB Status Sessions Tab" >}}
