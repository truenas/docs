...
3. Add a namespace. Click **Add** to open the **Add Namespace** screen. The screen opens with the **Zvol** tab selected.
   ...
   {{< trueimage src="/images/shares/edit-namespace-existing-file-tab.png" alt="Edit Namespace Existing File Tab" id="Edit Namespace Existing File Tab" >}}
   ...
   {{< trueimage src="/images/shares/edit-namespace-new-file-tab.png" alt="Edit Namespace New File Tab" id="Edit Namespace New File Tab" >}}
