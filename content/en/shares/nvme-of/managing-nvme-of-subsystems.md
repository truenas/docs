...
{{< include file="/static/includes/nvme-tcp-esxi-limitation.md" >}}
...
{{< trueimage src="/images/shares/edit-namespace-screen-zvol-tab.png" alt="Edit Namespace Zvol Tab" id="Edit Namespace Zvol Tab" >}}
...
{{< trueimage src="/images/shares/use-existing-file-in-edit-namespace.png" alt="Using an Existing File" id="Using an Existing File" >}}
...
{{< trueimage src="/images/shares/add-new-file-to-namespace.png" alt="Adding a New File" id="Adding a New File" >}}
...
You can change the port number assigned to the subsystem using the {{< trueimage src="/images/shares/remove-from-subsystem.png" alt="Remove from Subsystem Icon" id="Remove from Subsystem Icon" >}} **Remove this port from the subsystem** icon on the **Ports** widget.
...
Click the {{< trueimage src="/images/shares/remove-from-subsystem.png" alt="Remove from Subsystem Icon" id="Remove from Subsystem Icon" >}} **Removes this host from the subsystem** icon to remove the host from the subsystem.
