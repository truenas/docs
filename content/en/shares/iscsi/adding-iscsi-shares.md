...
Before adding iSCSI shares, make sure you have already created a [zvol](# <!-- TODO-REF: AddManageZvols -->) or a [dataset](# <!-- TODO-REF: DatasetsSCALE -->) with at least one file to share. Do not use capital letters or spaces in the names or path.
...
1.  Click **Create New** on the **Target** screen, then click **Next** or on **Extent** to go to next screen.
   ...
   {{< trueimage src="/images/shares/iscsi-wizard-target-screen.png" alt="iSCSI Wizard Target Screen" id="iSCSI Wizard Target Screen" >}}
...
2. Add the extent and select the device type.
   ...
   {{< columns >}}
   {{< trueimage src="/images/shares/iscsi-wizard-extent-create-new-device.png" alt="iSCSI Wizard Extent Screen Devices Settings" id="iSCSI Wizard Extent Screen Device Settings" >}}
   <--->
   {{< trueimage src="/images/shares/iscsi-wizard-extend-file-type.png" alt="iSCSI Wizard Extent Screen File Settings" id="iSCSI Wizard Extent Screen File Settings" >}}
   {{< /columns >}}
...
3. Create a portal or select an available existing portal.
   ...
   {{< trueimage src="/images/shares/iscsi-wizard-protocol-options-create-new-portal.png" alt="iSCSI Wizard Protocol Options Screen Portal Settings" id="iSCSI Wizard Protocol Options Screen Portal Settings" >}}
...
1. Add a target.
   ...
   {{< trueimage src="/images/shares/add-iscsi-target-screen.png" alt="Add iSCSI Target Screen" id="Add iSCSI Target Screen" >}}

   a. Click **Add** to open the **Add iSCSI Target** screen.

   {{< trueimage src="/images/shares/add-iscsi-target-screen-add-group-and-network.png" alt="Add iSCSI Target Screen" id="Add iSCSI Target Screen" >}}
   ...
   d. (Optional) Click **Add** to the right of **Add Groups** to enter portal settings.
      ...
      **None** allows anonymous discovery. **CHAP** uses one-way authentication. **Mutual CHAP** uses two-way authentication.
      ...
      For more information on authentication methods, see [iSCSI Screens](# <!-- TODO-REF: iSCSISharesScreens -->).
...
2. Add extent(s). Click on the **Extents** tab, then click **Add** to open the **Add iSCSI Extent** screen.
   ...
   {{< columns >}}
{{< trueimage src="/images/shares/add-extent-screen-device-type.png" alt="Add iSCSI Extent Device Type" id="Add iSCSI Extent Device Type" >}}
<--->
{{< trueimage src="/images/shares/add-extent-screen-file-type.png" alt="Edit iSCSI Extent File Type" id="Edit iSCSI Extent File type" >}}
{{< /columns >}}
...
3. Add initiator groups. Click on the **Initiators** tab, then click **Add** to open the **Add Initiator** screen.
   ...
   {{< trueimage src="/images/shares/add-initiator-screen.png" alt="Add Initiator Screen" id="Add Initiator Screen" >}}
...
4. Add portals. Click on the **Portals** tab, then click **Add** to open the **Add Portal** screen.
   ...
   {{< trueimage src="/images/shares/add-portal-screen.png" alt="Add Portal Screen" id="Add Portal Screen" >}}
...
5. Enter authorized access networks. Click on the **Authorized Access** tab, then click **Add** to open the **Add Authorized Access** screen.
   ...
   {{< trueimage src="/images/shares/add-authorized-access-screen.png" alt="Add Authorized Access Screen" id="Add Authorized Access Screen" >}}
