...
{{< trueimage src="/images/shares/linux-iscsi-app-install.png" alt="Linux ISCSI App Install" id="Linux ISCSI App Install" >}}
...
1. Run the command `sudo iscsiadm \--mode discovery \--type sendtargets \--portal {IPADDRESS}`.
   ...
   {{< trueimage src="/images/shares/linux-iscsi-discovery-list.png" alt="Linux ISCSI Discovery List" id="Linux ISCSI Discovery List" >}}
...
2. Enter comand `sudo iscsiadm \--mode node \--targetname {BASENAME}:{TARGETNAME} \--portal {IPADDRESS} \--login`,
   ...
   {{< trueimage src="/images/shares/linux-iscsi-login.png" alt="Linux ISCSI Login" id="Linux ISCSI Login" >}}
...
Now you partition an iSCSI disk.
   ...
   {{< trueimage src="/images/shares/fdisk-list.png" alt="fdisk -l output" id="fdisk -l output" >}}
   ...
   {{< trueimage src="/images/shares/fdisk-partition.png" alt="fdisk partitioning" id="fdisk partitioning" >}}
...
{{< trueimage src="/images/shares/linux-iscsi-filesystem.png" alt="Linux ISCSI Filesystem" id="Linux ISCSI Filesystem" >}}
...
{{< trueimage src="/images/shares/windows-iscsi-initiator-app.png" alt="Windows ISCSI Initiator App" id="Windows ISCSI Initiator App" >}}

Next, go to the **Configuration** tab and click **Change** to replace the iSCSI initiator with the name created earlier. Click **OK**.

{{< trueimage src="/images/shares/windows-iscsi-initiator-config-name.png" alt="Windows ISCSI Initiator Config Name" id="Windows ISCSI Initiator Config Name" >}}
...
{{< trueimage src="/images/shares/windows-iscsi-initiator-discover-portal.png" alt="Windows ISCSI Initiator Discover Portal" id="Windows ISCSI Initiator Discover Portal" >}}

Go to the **Targets** tab, highlight the iSCSI target, and click **Connect**.

{{< trueimage src="/images/shares/windows-iscsi-initiator-target-connect.png" alt="Windows ISCSI Initiator Target Connect" id="Windows ISCSI Initiator Target Connect" >}}

After Windows connects to the iSCSI target, you can partition the drive.

Search for and open the **Disk Management** app.

{{< trueimage src="/images/shares/windows-iscsi-disk-management-app.png" alt="Windows ISCSI Disk Management App" id="Windows ISCSI Disk Management App" >}}

The current state of your drive should be **unallocated**. Right-click the drive and click **New Simple Volume...**.

{{< trueimage src="/images/shares/windows-iscsi-disk-new-volume.png" alt="Windows ISCSI Disk New Volume" id="Windows ISCSI Disk New Volume" >}}

Complete the wizard to format the drive and assign a drive letter and name.

{{< trueimage src="/images/shares/windows-iscsi-disk-new-volume-options.png" alt="Windows ISCSI Disk New Volume Options" id="Windows ISCSI Disk New Volume Options" >}}
...
{{< trueimage src="/images/shares/windows-iscsi-volume-location.png" alt="Windows iSCSI Volume Location" id="Windows iSCSI Volume Location" >}}
{{< /expand >}}
