...
{{< trueimage src="/images/shares/iscsi-block-shares-widget-no-shares.png" alt="Block (iSCSI) Share Target Widget without Shares" id="Block (iSCSI) Share Target Widget without Shares" >}}

After adding a share, the widget lists them in a table.

{{< trueimage src="/images/shares/iscsi-block-shares-widget.png" alt="Block (iSCSI) Share Target Widget without Shares" id="Block (iSCSI) Share Target Widget without Shares" >}}
...
{{< trueimage src="/images/shares/start-iscsi-service-dialog.png" alt="Start iSCSI Service Dialog" id="Start iSCSI Service Dialog" >}}
...
{{< include file="/static/includes/fibre-channel-enterprise-screen.md" >}}
...
{{< trueimage src="/images/shares/iscsi-wizard-protocol-options-create-new-portal.png" alt="iSCSI Wizard Protocol Options Screen Settings" id="iSCSI Wizard Protocol Options Screen Settings" >}}
...
{{< trueimage src="/images/shares/iscsi-targets-screen.png" alt="iSCSI Target Screen" id="iSCSI Target Screen" >}}
...
<--->
{{< trueimage src="/images/shares/edit-iscsi-target-screen.png" alt="Edit iSCSI Target Screen" id="Edit iSCSI Target Screen" >}}
{{< /columns >}}
...
{{< trueimage src="/images/shares/iscsi-extents-screen.png" alt="iSCSI Extents Screen" id="iSCSI Extents Screen" >}}
...
{{< trueimage src="/images/shares/iscsi-initiators-screen.png" alt="iSCSI Initiator Screen" id="iSCSI Initiator Screen" >}}
...
{{< trueimage src="/images/shares/iscsi-portals-screen.png" alt="iSCSI Portals Screen" id="iSCSI Portals Screen" >}}
...
{{< trueimage src="/images/shares/iscsi-authorized-access-screen.png" alt="iSCSI Authorized Access Screen" id="iSCSI Authorized Access Screen" >}}
