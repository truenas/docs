...
{{< trueimage src="/images/datasets/dataset-zvol-listing.png" alt="Edit Zvol LUN" id="Edit Zvol LUN" >}}
...
{{< trueimage src="/images/shares/file-luns-edit-extent.png" alt="Extents Screen" id="Extents Screen" >}}

Click the <i class="material-icons" aria-hidden="true" title="Options">more_vert</i> next to the file-based LUN and select **Edit**.

{{< trueimage src="/images/shares/file-luns-edit-extent2.png" alt="Edit Extent" id="Edit Extent" >}}
