...
Once you have [migrated to TrueNAS 24.04](# <!-- TODO-REF: MigratingFromCore -->), you can find your migrated AFP configuration in **Shares >** **Windows Shares (SMB)** with the prefix **AFP_**.
To make the migrated AFP share accessible, start the SMB service.

{{< trueimage src="/images/shares/migrated-afp-share.png" alt="Migrated AFP Share" id="Migrated AFP Share" >}}
