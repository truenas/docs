...
{{< trueimage src="/images/shares/nfs-share-widget-no-share.png" alt="Unix (NFS) Share Widget" id="Unix (NFS) Share Widget" >}}
...
{{< trueimage src="/images/shares/nfs-share-widget-with-shares.png" alt="Unix (NFS) Share Widget with Shares" id="Unix (NFS) Share Widget with Shares" >}}
...
{{< trueimage src="/images/shares/sharing-nfs-enable-service-dialog.png" alt="Unix Enable Service" id="Unix Enable Service" >}}
...
{{< trueimage src="/images/shares/sharing-nfs-delete-dialog.png" alt="Sharing NFS Delete" id="Sharing NFS Delete" >}}
...
{{< trueimage src="/images/shares/nfs-shares-screen.png" alt="Shares NFS Screen" id="Shares NFS Screen" >}}
...
{{< trueimage src="/images/shares/add-nfs-advanced-options-access-settings.png" alt="Add NSF Advanced Options Access Settings" id="Add NSF Advanced Options Access Settings" >}}
...
{{< trueimage src="/images/shares/nfs-sessions-screen.png" alt="NFS Sessions Screen" id="NFS Sessions Screen" >}}
