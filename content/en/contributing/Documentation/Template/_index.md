...
Refer to the [Style Guide]({{< ref "/contributing/documentation/style" >}}) for specific text syntax and formatting examples, Markdown and Hugo website enhancements, and content guidelines to follow.
