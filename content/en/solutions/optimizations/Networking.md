...
See [Setting Up Static IPs](https://www.truenas.com/docs/scale/network/interfaces/) for more information.
...
See [Setting Up SMB Multichannel](https://www.truenas.com/docs/scale/shares/smb/) for more information.
...
See also [Setting Up a Network VLAN](https://www.truenas.com/docs/scale/network/).
...
See [Managing Interfaces](https://www.truenas.com/docs/scale/network/interfaces/).
...
For more information, see [Block Shares (iSCSI)](https://www.truenas.com/docs/scale/shares/iscsi/).
