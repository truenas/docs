...
1. Generate an API key for Kubernetes.
   ...
   For more information on TrueNAS API keys, see [Managing API Keys](https://www.truenas.com/docs/scale/toptoolbar/managingapikeys/).
...
3. Create a new pool or locate a pool with enough storage to accommodate the Kubernetes cluster storage needs.
   ...
   For more information on creating new pools, see [Creating Pools](https://www.truenas.com/docs/scale/storage/pools/creatingpools/). To increase storage in an existing pool, see [Expanding a Pool in Managing Pools](https://www.truenas.com/docs/scale/storage/pools/managepools/).
