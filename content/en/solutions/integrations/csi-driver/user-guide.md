...
For an overview of the Kubernetes/CSI driver integration see [TrueNAS CSI Driver]({{< ref "/solutions/integrations/csi-driver/_index.md" >}})

For reference material including a glossary of terms, see [CSI Driver Reference]({{< ref "/solutions/integrations/csi-driver/reference" >}})

[Kubernetes Cluster Administrators Guide]({{< ref "/solutions/integrations/csi-driver/administrators-guide" >}}) provides instructions on configuring StorageClasses and the Kubernetes integration with the CSI driver.
