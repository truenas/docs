...
Refer to the basic [SMB Share]({{< relref "/SCALE/Shares/SMB/_index.md" >}}) instructions for information on creating a share user.
...
When deploying an iSCSI share requiring a zvol (LUN), users should consider [thin provisioning]({{< ref "/references/thinprovisioning" >}}) using the sparse option during setup.
