...
Refer to the basic [SMB Share](https://www.truenas.com/docs/scale/shares/smb/) instructions for information on creating a share user.
...
When deploying an iSCSI share requiring a zvol (LUN), users should consider [thin provisioning]({{< ref "/references/thin-provisioning" >}}) using the sparse option during setup.
