...
{{< trueimage src="/images/Solutions/CrossRecoveryDirections.png" alt="CrossRecoveryDirections" id="CrossRecoveryDirections" >}}
...
{{< trueimage src="/images/CORE/Tasks/TasksRsynctasksAddExample.png" alt="Example Rsync Task" id="Example Rsync Task" >}}
...
{{< trueimage src="/images/Solutions/StorageDesignExample.png" alt="Example Storage Design" id="Example Storage Design" >}}
