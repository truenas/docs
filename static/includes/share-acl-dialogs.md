...
{{< trueimage src="/images/shares/share-acl-warning-dialog.png" alt="Strip ACL Warning" id="Strip ACL Warning" >}}
...
TrueNAS shows a **Configure ACL** dialog to remind you to edit the ACL if you did not stop to strip the ACL.

{{< trueimage src="/images/shares/smb-share-configure-acl-dialog.png" alt="Configure ACL Dialog" id="Configure ACL Dialog" >}}
