...
**SMB Access** is the default user access type that allows using the account credentials to access data shared with [SMB](# <!-- TODO-REF: /SCALE/SCALEUIReference/Shares -->).
...
4. Enter additional details for the user. Setting options change based on the access option selected.
   **Shell Access** and **SSH Access** show the **Shell** and **Sudo Command** settings.
   ...
   {{< trueimage src="/images/credentials/add-user-additional-details-settings.png" alt="Additional Details Settings" id="Additional Details Settings" >}}
   ...
   {{< trueimage src="/images/credentials/add-user-group-setting-options.png" alt="User Group Settings" id="User Group Settings" >}}
   ...
   {{< trueimage src="/images/credentials/adding-a-home-directory.png" alt="User Home Directory Settings" id="User Home Directory Settings" >}}
   ...
   {{< trueimage src="/images/credentials/add-user-sudo-setting-options.png" alt="Add User Sudo Command Options" id="Add User Sudo Command Options" >}}
